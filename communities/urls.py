...
urlpatterns = [
    ...
    path('<str:movie_title>/board/<int:post_num>/comment/<int:comment_id>/edit/', views.comment_edit, name='comment_edit'),
    path('<str:movie_title>/board/<int:post_num>/comment/<int:comment_id>/delete/', views.comment_delete, name='comment_delete'),
    path('<str:movie_title>/board/<int:post_num>/comment/<int:comment_id>/reply/<int:reply_id>/edit/', views.reply_edit, name='reply_edit'),
    ...
    path('bamboo/<int:post_num>/comment/<int:comment_id>/edit/', views.comment_edit, name='comment_edit'),
    path('bamboo/<int:post_num>/comment/<int:comment_id>/delete/', views.comment_delete, name='comment_delete'),
    path('bamboo/<int:post_num>/comment/<int:comment_id>/reply/<int:reply_id>/edit/', views.reply_edit, name='reply_edit'),
